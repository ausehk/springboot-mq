package com.cgcx.common.utils.http;

import com.cgcx.common.utils.json.JacksonHelper;
import okhttp3.*;
...
public class HttpUtils {
    ...
    public String syncPostJSONRequest(String url, Map<String, String> headerMap, Map<String, String> paramMap, CacheControl cacheControl) throws IOException {
        ...
        //获取RequestBody
        RequestBody requestBody = RequestBody.create(MEDIA_TYPE_JSON, JacksonHelper.convertObjectToJson(paramMap));
